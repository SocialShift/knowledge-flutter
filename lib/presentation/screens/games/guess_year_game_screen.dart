...
class GuessYearGameScreen extends ConsumerStatefulWidget {
  const GuessYearGameScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<GuessYearGameScreen> createState() =>
      _GuessYearGameScreenState();
}

class _GuessYearGameScreenState extends ConsumerState<GuessYearGameScreen> {
  ...
  void _loadQuestions() async {
    ...
    try {
      final questions =
          await ref.read(gameQuestionsProvider(kGuessYearGameType).future);
